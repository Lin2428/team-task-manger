                    ...
                    <tr class="bg-white border-b hover:bg-gray-100 hover:shadow-xl">
                        ...
                        <th scope="row" class="table-th-name border-l">
                            <div class="flex justify-between items-center w-full">
                                ...
                                <a href="/messages/index/<?= $projectUser->project->id ?>" data-tooltip-target="tooltip-open-message" class=" ml-2 px-4  h-full border-l"><i class="bi bi-chat-dots text-lg text-gray-700"></i></a>
