...
<div class="mx-8 py-3">
    ...
    <a href="/tasks/index/<?= $project->id ?>" data-tooltip-target="tooltip-taches" class="hover:bg-gray-300 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center" type="button">
